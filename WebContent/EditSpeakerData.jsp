...
<br>
	...
	<div>
		<h3>Welcome <i>${sessionScope.session_username}</i>!</h3>
		You can edit your information here. You can also add or delete a talk here.
	</div>

<br>


	<s:form action="ProcessEditFormData" method="post" id="surveyform"
		...
		<table>
			...
			<tr>
				...
				<td><s:fielderror fieldName="address1" /></td>
			</tr>
			<tr>
				...
				<td><s:fielderror fieldName="address2" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="speakerlabel"><s:textfield name="username"
						...
						cssClass="speakertextfield" value="%{#session.session_username}" /></td>
			...
			<tr>
				...
				<td class="speakerlabel"><s:textfield name="password"
						...
						cssClass="speakertextfield" value="%{#session.session_password}" /></td>
...
<br>
	    ...
	    <td><s:submit type="button" cssClass="button" value="Cancel" action="CancelEditSpeakerData" /></td>
	    <td><s:submit type="button" cssClass="button" value="Add A Talk" action="GoToAddATalkSpeaker" /></td>
	    </tr>
	    </table>
		</s:form>
